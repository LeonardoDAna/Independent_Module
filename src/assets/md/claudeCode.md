...
<div class="timeline-wrap">
  ...
  <p><strong>2026 年 4 月</strong> — Claude Opus 4.7 发布（4 月 16 日 GA）：在高难度软件工程、高分辨率视觉与长程任务可靠性上较 Opus 4.6 明显提升；针对高风险网络安全场景引入自动拦截，并开放 Cyber Verification Program 供合规安全研究使用</p>  
  <p><strong>未来</strong> — 官方已披露受限发布的 <strong>Claude Mythos Preview</strong>（Anthropic 自述能力强于广泛可用的 Opus 4.7，与「Mythos 类模型」渐进开放路线相关）。网传内部层级代号「Capybara」与 <strong>Sonnet 4.8</strong> 等尚未有与 Opus 4.7 同级的产品级官宣，宜以 <a href="https://www.anthropic.com/news" rel="noopener noreferrer">Anthropic 新闻</a> 与 API 发布说明为准</p></div>
